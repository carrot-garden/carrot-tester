...
public class TestPacketTableLib {
	...
	private static final Logger logger = Logger
			.getLogger(TestPacketTableLib.class);
	...
	private class PacketStruct extends Struct {
		...
		public boolean equals(Object obj) {
			...
			return ((this.int32.get() == other.int32.get())
					&& (this.int8.get() == other.int8.get()) && (this.float64
					.get() - other.float64.get() < 1e-10));
		}
	...
	public void setUp() throws Exception {
		...
		int plFAccess = PropertiesLib.H5Pcreate(PropertiesLib
				.getH5P_FILE_ACCESS_CLASS());
	...
	/**
	 * Test method for
	 * {@link permafrost.hdf.libhdf.PacketTableLib#H5PTcreate_fl(int, java.lang.String, int, java.math.BigInteger, int)}
	 * .
	 */
	@Test
	public void testH5PTcreate_fl() {
		...
		int tbId = PacketTableLib.H5PTcreate_fl(this.fid, dsetName, this.pktId,
				chunkSize, 0);
		assertTrue(tbId > 0);
	...
	/**
	 * Test method for
	 * {@link permafrost.hdf.libhdf.PacketTableLib#H5PTopen(int, java.lang.String)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link permafrost.hdf.libhdf.PacketTableLib#H5PTclose(int)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link permafrost.hdf.libhdf.PacketTableLib#H5PTappend(int, long, java.nio.Buffer)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link permafrost.hdf.libhdf.PacketTableLib#H5PTget_next(int, long, java.nio.Buffer)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link permafrost.hdf.libhdf.PacketTableLib#H5PTread_packets(int, java.math.BigInteger, long, java.nio.Buffer)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link permafrost.hdf.libhdf.PacketTableLib#H5PTget_num_packets(int, long[])}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link permafrost.hdf.libhdf.PacketTableLib#H5PTis_valid(int)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link permafrost.hdf.libhdf.PacketTableLib#H5PTcreate_index(int)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link permafrost.hdf.libhdf.PacketTableLib#H5PTset_index(int, java.math.BigInteger)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link permafrost.hdf.libhdf.PacketTableLib#H5PTget_index(int, long[])}.
	 */
	@Test
	...
	private int createPacketType() {
		...
		int idStruct = DatatypeLib.H5Tcreate(DatatypeClassType.H5T_COMPOUND,
				struct.size());
		...
		int insertStatus = DatatypeLib.H5Tinsert(idStruct, intName,
				struct.int32.offset(), DatatypeLib.getH5T_STD_I32BE());
		
		assertTrue(insertStatus >= 0);
		
		final String charName = "int8";
		
		insertStatus = DatatypeLib.H5Tinsert(idStruct, charName,
				struct.int8.offset(), DatatypeLib.getH5T_STD_I8BE());
		
		assertTrue(insertStatus >= 0);
		
		final String floatName = "float64";
		
		insertStatus = DatatypeLib.H5Tinsert(idStruct, floatName,
				struct.float64.offset(), DatatypeLib.getH5T_IEEE_F64BE());
