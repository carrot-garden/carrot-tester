...
ssize_t H5Iget_name(hid_t id, char* name, size_t size); /*out*/
...
herr_t H5Tenum_nameof(hid_t type, const void* value, char* name, size_t size); /*out*/
...
herr_t H5Tget_pad(hid_t type_id, H5T_pad_t* lsb, H5T_pad_t* msb); /*out*/
H5T_sign_t H5Tget_sign(hid_t type_id);
herr_t H5Tget_fields(hid_t type_id, size_t* spos, size_t* epos, size_t* esize, size_t* mpos, size_t* msize); /*out*/
